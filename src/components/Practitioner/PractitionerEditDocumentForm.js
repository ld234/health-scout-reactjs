...
class PractitionerEditDocumentForm extends Component{
    constructor(props){
        super(props);
        this.state ={
            title: this.props.documentState.documents[this.props.hoveredItem].title,
            description: this.props.documentState.documents[this.props.hoveredItem].description,
            chooseFile:this.props.documentState.documents[this.props.hoveredItem].chooseFile,
            fileName: this.props.documentState.documents[this.props.hoveredItem].chooseFile[0].name,
            error: null,
        }
    }
...
export default connect(mapStateToProps,mapDispatchToProps)(PractitionerEditDocumentForm);
